// src/modules/admin/pages/departments/DepartmentEdit.jsx
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          ...
          <p className="text-muted mb-0">
            Update department name for Department ID: #{id}
          </p>
        </div>
        <div className="btn-group">
          ...
          <Link to={`/admin/departments/delete/${id}`} className="btn btn-outline-danger">
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  ...
                  <div className="form-text">
                    Changing the department name will update it for all assigned doctors.
                  </div>
                </div>
