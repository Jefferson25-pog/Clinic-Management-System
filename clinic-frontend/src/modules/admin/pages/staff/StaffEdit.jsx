// src/modules/admin/pages/staff/StaffEdit.jsx - COMPLETE UPDATED VERSION
...
const StaffEdit = () => {
  ...
  const fetchStaffData = async () => {
    try {
      ...
      if (data.qualifications && Array.isArray(data.qualifications)) {
        setQualifications(data.qualifications.map((q, index) => ({
          id: q.id || Date.now() + index,
          qualification_name: q.qualification_name || "",
          institution: q.institution || "",
          year_completed: q.year_completed || new Date().getFullYear(),
          specialization: q.specialization || "",
          registration_number: q.registration_number || "",
          is_primary: q.is_primary || (index === 0 && !data.Qualification)
        })));
      }
  ...
  // Qualification Management Functions (same as in StaffAdd)
  const addQualification = () => {
    setQualifications([
      ...qualifications,
      {
        ...
        specialization: "",
        registration_number: "",
        is_primary: qualifications.length === 0
      }
    ]);
  };
  ...
  const updateQualification = (index, field, value) => {
    ...
    if (field === 'is_primary' && value) {
      updatedQualifications.forEach((qual, i) => {
        if (i !== index) updatedQualifications[i].is_primary = false;
      });
    }
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          ...
          <p className="text-muted mb-0">
            Updating details for {formData.Name} (ID: {id})
          </p>
        </div>
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-4 mb-3">
                          ...
                          <input 
                            ...
                            placeholder={formData.Role === 'Doctor' ? 'e.g., 123456 or TN/12345/2010' : 
