  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const appointmentData = {
        ...
        Date: formData.Date,
        // Add token number (will be auto-generated by backend, but we calculate for display)
        TOKEN_NO: todayToken
      };
      ...
      if (response.data) {
        const appointmentId = response.data.TOKEN_NO || response.data.id;
        alert(`Appointment scheduled successfully!\nToken Number: TOK-${todayToken.toString().padStart(4, '0')}`);
